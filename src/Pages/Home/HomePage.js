  ...
  return (
    <DIV className={`${className}`}>
         ...
         <PopularSection className='mt-5  dispaly-none-600px'></PopularSection>
          ...
          <ProductsRow className="mt-5" title={"Popular in Used Cars for Sale"} data={data2}></ProductsRow>
          <ProductsRow className="mt-5" title={"Popular in Residential for Rent"} data={data3}></ProductsRow>
