    ...
    <DIV className={`${className} display-flex align-items-center`}>
         <div className="RegistarPage-wrapper pb-5 pt-5 ps-2 pe-2 border-radius-10  ">
                 ...
                 <input className="input w-100 p-2  ps-3 mt-4" placeholder='mobile number'></input>  
                    ...
                    <Button className='background-primary border-radius-20 font-1-2 text-color-white mt-4'  text={"SIGN UP "}></Button>
         
         
                    <div className="sign-in text-center mt-2">
                        <span className=' font-1-1 text-color-grey'> Don't have an account ? </span>
                        <span className=' font-1-1 cursor-p text-color-primary fw-bold '>Sign in</span>
                    </div>
                    ...
                    <div className=" social-media-container font-1-1 mt-1">
                        <div className="text-color-grey text-center font-1-2"> Continue with social media</div>
                            ...
                            <div className="social display-flex  mt-2">
                                    ...
                                    <div className="social-media-btn border-radius-20 w-49 ms-auto justify-content-center">
